...
void Level3::LoadSimulation( ActiveSimulation simulation )
{
	...
	case SIMULATION_4:
	{		
		rigidCubes[0]->SetPosition( -2.0f, 2.5f, 6.0f );
		rigidCubes[1]->SetPosition( 2.0f, 2.5f, 6.0f );
...
void Level3::Render( Graphics& gfx )
{
	...
	SpawnSimulationWindow( gfx );

	LevelManager::EndRender( gfx );
}

void Level3::SpawnSimulationWindow( Graphics& gfx )
{
	if ( ImGui::Begin( "Active Simulation" ), FALSE, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoMove )
	{
